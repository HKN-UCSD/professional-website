    ...
    const loadCarouselImages = async () => {
      try {
        const imageModules = import.meta.glob(
          '/src/media/images/landing/carousel/*.{jpg,jpeg,png,webp}',
          { eager: true, as: 'url' }
        );

        const imagePaths = Object.keys(imageModules).map(
          ...
          <section className="max-w-6xl mx-auto">
            ...
            <div className="max-w-4xl text-center mx-auto">
              <p className="text-lg text-blue-200/90">
                Eta Kappa Nu (IEEE-HKN) is the official engineering honor society
                of IEEE, dedicated to helping engineers become better engineers—
                both in and beyond the classroom. At UC San Diego, the Kappa Psi
                chapter brings together top students in ECE, CSE, MAE, BENG,
                MATH-CS, COGS-ML, and DSC who demonstrate academic excellence,
                leadership, and strong character. Through our social, technical,
                professional, outreach, and project-based events, we empower
                members to grow as innovators, collaborators, and leaders. HKN
                provides a community where engineers can connect, learn, and make
