...
function CarouselCard({ img, title, content }) {
    return (
        <div className="grid grid-cols-3 flex-wrap items-center p-6 mb-6" style={{background: 'rgba(0, 0, 0, 0.2)', borderRadius: '12px', border: '1px solid rgba(163, 215, 229, 0.2)'}}>
